...
class SB3_MAS_Train_Parallelized_Processes:
    def __init__(self, 
                 num_agents,
                 num_episodes,
    ...
    # print(rewards)
        ...
        plt.tight_layout()
        plt.savefig(f"rewards_plot_{self.num_episodes - 1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_battery_levels(self, levels):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"avg_battery_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_battery_levels_individual(self, levels):
        ...
        for i in range(0, self.env._num_agents):
            ...
            plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
            plt.tight_layout()
            plt.savefig(f"avg_battery_plot_{self.battery_capacities[i]}Wh_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
            plt.close()
    ...
    def plot_backlogs(self, backlogs):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"backlog_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_battery_daily(self, data):    
        for elem in range(0, self.env._num_agents):
            ...
            plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
            plt.tight_layout()
            plt.savefig(f"battery_{int(self.env.battery_capacities[elem] / 3600)}Wh_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
            plt.close()
    ...
    def plot_backlog_daily(self, data):
        ...
        for elem in range(0, self.env._num_agents):
            ...
            plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
            plt.tight_layout()
            plt.savefig(f"backlog_{int(self.env.battery_capacities[elem] / 3600)}Wh_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.num_agents}agents_processes_{self.mode}.pdf")
            plt.close()        
    ...
    def plot_framerate(self, fs):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"framerate_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.env._num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_local_framerate(self, fs):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"local_framerate_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.env._num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_offloading_framerate(self, fs):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"offloading_framerate_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.env._num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
    ...
    def plot_offloading_matchings(self, fs):
        ...
        plt.legend(bbox_to_anchor=(0.5, -0.2), loc='upper center', ncol=3)
        plt.tight_layout()
        plt.savefig(f"offloading_matchings_plot_{self.num_episodes-1}_{self.env.episode}_{self.proc_interval}_{self.w}_{self.env._num_agents}agents_processes_{self.mode}.pdf")
        plt.close()
